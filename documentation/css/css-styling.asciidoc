...
1. Create a theme file (by convention this file should be in the `webapp/frontend/src/styles directory`). The theme's dom-module must declare `theme-for=vaadin-chart`.
...
[source, java]
----
@HtmlImport("frontend://src/styles/css-style-example.html")
