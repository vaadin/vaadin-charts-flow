...
You can style the range selector buttons with the `highcharts-range-selector-buttons` class in CSS.

[source, css]
----
:host .highcharts-range-selector-buttons > .highcharts-button-pressed {
  fill: #7cb5ec;
}

:host .highcharts-range-selector-buttons > .highcharts-button-pressed > text {
  fill: white;
}
----
