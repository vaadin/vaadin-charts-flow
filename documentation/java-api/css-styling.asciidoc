...
2. Declare `include="vaadin-chart-default-theme"` on the theme module's style element to customize Chart's default theme. If there are multiple theme modules *only one* of them should declare this `include`.
