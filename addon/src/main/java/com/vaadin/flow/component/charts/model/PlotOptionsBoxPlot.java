 ...
 * [plotOptions.series](plotOptions.series) object. 2. Options for all `boxplot`
 * series are defined in [plotOptions.boxplot](plotOptions.boxplot). 3. Options
 * for one single series are given in [the series instance
 * array](series.boxplot).
 * 
 * <pre>
...
public class PlotOptionsBoxPlot extends AbstractPlotOptions {
	...
	/**
	 * The fill color of the box. In styled mode, the fill color can be set with
	 * the `.highcharts-boxplot-box` class.
	 */
	 ...
	 * applies. In styled mode, the median stroke width can be set with the
	 ...
	 * [lineWidth](#plotOptions.boxplot.lineWidth) is used. In styled mode, the
	 * median stroke width can be set with the `.highcharts-boxplot-median`
	 * class.
	 */
	 ...
	 * whiskers. If `null`, the series color is used. In styled mode, the stem
	 * stroke can be set with the `.highcharts-boxplot-stem` class.
	 */
	 ...
	 * whiskers. If `null`, the width is inherited from the
	 * [lineWidth](#plotOptions.boxplot.lineWidth) option. In styled mode, the
	 * stem stroke width can be set with the `.highcharts-boxplot-stem` class.
	 */
	 ...
	 * values. When `null`, the general series color is used. In styled mode,
	 * the whisker stroke can be set with the `.highcharts-boxplot-whisker`
	 * class .
	 */
	 ...
	 * [lineWidth](#plotOptions.boxplot.lineWidth) applies. In styled mode, the
	 * whisker stroke width can be set with the `.highcharts-boxplot-whisker`
	 * class.
	 */
