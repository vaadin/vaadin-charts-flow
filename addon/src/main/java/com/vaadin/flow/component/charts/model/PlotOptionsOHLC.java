 ...
 * [plotOptions.series](plotOptions.series) object. 2. Options for all `ohlc`
 * series are defined in [plotOptions.ohlc](plotOptions.ohlc). 3. Options for
 * one single series are given in [the series instance array](series.ohlc).
 * 
 * <pre>
