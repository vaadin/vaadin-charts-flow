 ...
 * [plotOptions.streamgraph](plotOptions.streamgraph). 3. Options for one single
 * series are given in [the series instance array](series.streamgraph).
 * 
 * <pre>
...
public class PlotOptionsStreamgraph extends AbstractPlotOptions {
