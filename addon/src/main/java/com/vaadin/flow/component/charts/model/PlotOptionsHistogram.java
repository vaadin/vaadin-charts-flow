...
public class PlotOptionsHistogram extends AbstractPlotOptions {

	private Number binWidth;
	private String _fn_binsNumber;
	...
	/**
	 * Width of each bin. By default the bin's width is calculated as `(max -
	 * min) / number of bins`. This option takes precedence over
	...
	/**
	 * @see #set_fn_binsNumber(String)
	 */
	public String getBinsNumber() {
		return _fn_binsNumber;
	}

	/**
	 * A preferable number of bins. It is a suggestion, so a histogram may have
	 * a different number of bins. By default it is set to the square root of
	 * the base series' data length. Available options are: `square-root`,
	 * `sturges`, `rice`. You can also define a function which takes a
	 * `baseSeries` as a parameter and should return a positive integer.
	 */
	public void setBinsNumber(String _fn_binsNumber) {
		this._fn_binsNumber = _fn_binsNumber;
	}
