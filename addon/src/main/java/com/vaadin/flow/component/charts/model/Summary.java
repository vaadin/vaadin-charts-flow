 ...
 * modes: 1. This series type is the only series type used in the chart 2. This
 * is a combination chart with multiple series types If a definition does not
 * exist for the specific series type and mode, the 'default' lang definitions
 * are used.
 */
@Generated(value = "This class is generated and shouldn't be modified", comments = "Incorrect and missing API should be reported to https://github.com/vaadin/vaadin-charts-flow/issues/new")
public class Summary extends AbstractConfigurationObject {
