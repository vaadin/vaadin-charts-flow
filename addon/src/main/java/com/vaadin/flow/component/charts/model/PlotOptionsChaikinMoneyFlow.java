 ...
 * [plotOptions.series](plotOptions.series) object. 2. Options for all `cmf`
 * series are defined in [plotOptions.cmf](plotOptions.cmf). 3. Options for one
 * single series are given in [the series instance array](series.cmf).
 * 
 * <pre>
...
public class PlotOptionsChaikinMoneyFlow extends AbstractPlotOptions {
	...
	public PlotOptionsChaikinMoneyFlow() {
	}
